...
from keras4jet.layers.senet.se_inception_resnet_v2 import se_inception_resnet_a
from keras4jet.layers.senet.se_inception_resnet_v2 import se_inception_resnet_b
from keras4jet.layers.senet.se_inception_resnet_v2 import se_inception_resnet_c
from keras4jet.layers.senet.se_inception_resnet_v2 import se_reduction_a
from keras4jet.layers.senet.se_inception_resnet_v2 import se_reduction_b
...
def build_a_model(input_shape,
    ...
    for _ in xrange(num_a):
        out = se_inception_resnet_a(out) 

    out = se_reduction_a(out)

    # Inception-ResNet-B
    for _ in xrange(num_b):
        out = se_inception_resnet_b(out) 

    # Reduction-B
    out = se_reduction_b(out)

    # Inception-ResNet-C
    for _ in range(num_c):
        out = se_inception_resnet_c(out)
...
if __name__ == "__main__":
    ...
    plot_model(
        model,
        show_shapes=True,
        to_file="/tmp/SE-Inception-ResNet-v2.png")
